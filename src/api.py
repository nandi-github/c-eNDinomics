...
MANIFEST_FILES = [
    ...
    # Default profile — canonical schema reference.
    # __testui__ and __system__* are generated by test_flags.py, NOT tracked here.
...
def run_simulation(payload: Dict[str, Any] = Body(...)):
    ...
    if modular_test:
        ...
        # W2 wages per path per year — passed to taxes_core for Additional Medicare Tax (0.9%)
        ...
        for y in range(_n_years):
            ...
            w2_income_cur_paths[:, y] = w2_cur[y]  # same for all paths (deterministic income)
        ...
        res = run_accounts_new(
            ...
            # w2_income_cur_paths is built above for future AMT wiring but not yet
            # passed here — simulator_new.py does not accept it yet. taxes_core.py
            # is already updated to compute AMT when w2_income_cur is provided.
            # Wiring through simulator_new.py is the next step.
            person_cfg=person_cfg,
