...
const App: React.FC = () => {
  ...
  const [runBaseYear, setRunBaseYear] = useState<number>(2026);
  const [runDollars, setRunDollars] = useState<string>("current");
          ...
          <div className="form-grid">
            ...
            <div className="field">
              ...
              <input
                type="number"
                value={runBaseYear}
                onChange={(e) => setRunBaseYear(Number(e.target.value) || 0)}
              />
            </div>
            ...
            <div className="field">
              ...
              <select
                value={runDollars}
                onChange={(e) => setRunDollars(e.target.value)}
              >
            ...
            <>
              <section className="results-section">
                ...
                <div className="run-params-grid">
                  <div>
                    <strong>Dollars:</strong> {snapshot.run_info.dollars}
                  </div>
                  <div>
                    <strong>Base Year:</strong> {snapshot.run_info.base_year}
                  </div>
                  <div>
